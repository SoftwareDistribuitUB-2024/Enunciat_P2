FastAPI
=========
[FastAPI](https://fastapi.tiangolo.com/) és un dels framweworks per a web aplications més ràpids del mercat, ja que es basa en Starlette un framework web de tipus
